...
namespace QLyTV.Models
{
    ...
    partial void OnPhiMuonChanging(decimal value);
    ...
    partial void OnNgayTraChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PhiPhat", DbType="Decimal(10,2)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PhiMuon", DbType="Decimal(10,2) NOT NULL")]
		public decimal PhiMuon
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_HoaDon", Storage="_User", ThisKey="MaThuThu", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class PhieuMuon : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _NgayTraDuKien;
    ...
    partial void OnNgayTraDuKienChanging(System.DateTime value);
    ...
    partial void OnisDeleteChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NgayTraDuKien", DbType="Date NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PhieuMuon", Storage="_User", ThisKey="MaDocGia", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PhieuMuon1", Storage="_User1", ThisKey="MaThuThu", OtherKey="Id", IsForeignKey=true)]
		public User User1
		{
			get
			{
			...
			set
			{
							...
							|| (this._User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.PhieuMuons1.Remove(this);
					}
					this._User1.Entity = value;
					if ((value != null))
					{
						value.PhieuMuons1.Add(this);
						this._MaThuThu = value.Id;
					}
					else
					{
	...
	public partial class ThuThuSach : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _NgayQuanLy;
    ...
    partial void OnMaSachChanging(int value);
    partial void OnMaSachChanged();
    partial void OnNgayQuanLyChanging(System.DateTime value);
    partial void OnNgayQuanLyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaThuThu", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int MaThuThu
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NgayQuanLy", DbType="Date NOT NULL")]
		public System.DateTime NgayQuanLy
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ThuThuSach", Storage="_User", ThisKey="MaThuThu", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<PhieuMuon> _PhieuMuons1;
    ...
    partial void OnModifiedByChanged();
		...
		public User()
		{
			this._HoaDons = new EntitySet<HoaDon>(new Action<HoaDon>(this.attach_HoaDons), new Action<HoaDon>(this.detach_HoaDons));
			this._PhieuMuons = new EntitySet<PhieuMuon>(new Action<PhieuMuon>(this.attach_PhieuMuons), new Action<PhieuMuon>(this.detach_PhieuMuons));
			this._PhieuMuons1 = new EntitySet<PhieuMuon>(new Action<PhieuMuon>(this.attach_PhieuMuons1), new Action<PhieuMuon>(this.detach_PhieuMuons1));
			this._ThuThuSaches = new EntitySet<ThuThuSach>(new Action<ThuThuSach>(this.attach_ThuThuSaches), new Action<ThuThuSach>(this.detach_ThuThuSaches));
			this._UserRoles = new EntitySet<UserRole>(new Action<UserRole>(this.attach_UserRoles), new Action<UserRole>(this.detach_UserRoles));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_HoaDon", Storage="_HoaDons", ThisKey="Id", OtherKey="MaThuThu")]
		public EntitySet<HoaDon> HoaDons
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PhieuMuon", Storage="_PhieuMuons", ThisKey="Id", OtherKey="MaDocGia")]
		public EntitySet<PhieuMuon> PhieuMuons
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PhieuMuon1", Storage="_PhieuMuons1", ThisKey="Id", OtherKey="MaThuThu")]
		public EntitySet<PhieuMuon> PhieuMuons1
		{
			get
			{
				return this._PhieuMuons1;
			}
			set
			{
				this._PhieuMuons1.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ThuThuSach", Storage="_ThuThuSaches", ThisKey="Id", OtherKey="MaThuThu")]
		public EntitySet<ThuThuSach> ThuThuSaches
		{
			get
			{
		...
		private void attach_PhieuMuons1(PhieuMuon entity)
		{
			this.SendPropertyChanging();
			entity.User1 = this;
		}
		
		private void detach_PhieuMuons1(PhieuMuon entity)
		{
			this.SendPropertyChanging();
			entity.User1 = null;
		}
